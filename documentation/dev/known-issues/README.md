...
| [PyAV CodecContext.close](pyav-codeccontext-close.md) | AudioCodecContext 没有 close() 方法 | ✅ 已修复 |
...
| [剪贴板事件驱动](clipboard-polling.md) | pyperclip 使用轮询，可改用 Qt QClipboard.changed 信号 | 低 | ⏳ 待重构 |
| [网络模式 cleanup 参数](network-cleanup-correct.md) | cleanup=false 硬编码，应随 stay_alive 参数联动 | 中 | ✅ 已修复 |
